...
@implementation BBSystemValue

//单例
+ (BBSystemValue *)sharedInstance
{
    static dispatch_once_t pred = 0;
    __strong static BBSystemValue * _sharedObject = nil;
    dispatch_once(&pred, ^{
...
- (BOOL)isOldDevice
{
    ...
    if ([platform isEqualToString:@"iPad3,4"])      return YES;
    if ([platform isEqualToString:@"iPad3,5"])      return YES;
    if ([platform isEqualToString:@"iPad3,6"])      return YES;
    return NO;
}
