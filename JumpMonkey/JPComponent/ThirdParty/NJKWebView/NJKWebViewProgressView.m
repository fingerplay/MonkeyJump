...
-(void)configureViews
{
    ...
    UIColor *tintColor = [UIColor colorWithRed:101.f / 255.f green:160.f / 255.f blue:255.f / 255.f alpha:1.0];
    _progressBarView.backgroundColor = tintColor;

    [self addSubview:_progressBarView];
    
    _barAnimationDuration = 1.5f;//0.27
...
- (void)setProgress:(float)progress animated:(BOOL)animated
{
    ...
    [UIView animateWithDuration:(isGrowing && animated) ? _barAnimationDuration : 0.0 delay:0 options:UIViewAnimationOptionCurveEaseOut animations:^{
