...
@interface NJKWebViewProgress : NSObject<UIWebViewDelegate,TSWebViewDelegate>
@property (nonatomic, njk_weak) id<NJKWebViewProgressDelegate>progressDelegate;
@property (nonatomic, njk_weak) id<UIWebViewDelegate,TSWebViewDelegate>webViewProxyDelegate;
