...
+ (NSMutableArray *)properties
{
    ...
    if (cachedProperties == nil) {
        ...
        //fix crash 4.6.4 by 修斯   待V4.6.4数据验证
//
//        [self dictForKey:&MJCachedPropertiesKey][NSStringFromClass(self)] = cachedProperties;
//
        if (cachedProperties && NSStringFromClass(self)) {
            [[self dictForKey:&MJCachedPropertiesKey] setObject:cachedProperties forKey:NSStringFromClass(self)];
        }
