...
+ (NSDate *) dateWithDaysZeroFromNow: (NSInteger)days {
    return [[NSDate getTheZeroTime:[NSDate date]] dateByAddingDays:days];
}
...
+ (NSDate *)dateWithTimeIntervalInMilliSecondSince1970:(long long)timeIntervalInMilliSecond {
    NSDate *date = nil;
    long long timeInterval = timeIntervalInMilliSecond;
...
{
    NSDateFormatter *formatter = [NSDateFormatter dateFormatterWithFormatString:format];
