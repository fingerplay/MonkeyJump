...
{//返回当前设备名称
    ...
    if(deviceName){ // 优化：如果APP已经获取过一次设备名，则不用反复执行
        return deviceName;
    }
    ...
    dispatch_once(&onceToken, ^{
        ...
        if ([platform isEqualToString:@"iPhone9,4"])    deviceName = @"iPhone7Plus";
        if ([platform isEqualToString:@"iPhone10,1"])   deviceName = @"iPhone8";
        if ([platform isEqualToString:@"iPhone10,4"])   deviceName = @"iPhone8";
        if ([platform isEqualToString:@"iPhone10,2"])   deviceName = @"iPhone8Plus";
        if ([platform isEqualToString:@"iPhone10,5"])   deviceName = @"iPhone8Plus";
        if ([platform isEqualToString:@"iPhone10,3"])   deviceName = @"iPhoneX";
        if ([platform isEqualToString:@"iPhone10,6"])   deviceName = @"iPhoneX";
        ...
        if ([platform isEqualToString:@"iPad5,3"])      deviceName =  @"iPadAir2";
        if ([platform isEqualToString:@"iPad5,4"])      deviceName =  @"iPadAir2";
        if ([platform isEqualToString:@"iPad6,3"])      deviceName =  @"iPadPro9.7";
        if ([platform isEqualToString:@"iPad6,4"])      deviceName =  @"iPadPro9.7";
        if ([platform isEqualToString:@"iPad6,7"])      deviceName =  @"iPadPro12.9";
        if ([platform isEqualToString:@"iPad6,8"])      deviceName =  @"iPadPro12.9";
        if ([platform isEqualToString:@"iPad6,11"])     deviceName =  @"iPad5";
        if ([platform isEqualToString:@"iPad6,12"])     deviceName =  @"iPad5";
        if ([platform isEqualToString:@"iPad7,1"])      deviceName =  @"iPadPro12.9inch";
        if ([platform isEqualToString:@"iPad7,2"])      deviceName =  @"iPadPro12.9inch";
        if ([platform isEqualToString:@"iPad7,3"])      deviceName =  @"iPadPro10.5inch";
        if ([platform isEqualToString:@"iPad7,4"])      deviceName =  @"iPadPro10.5inch";
